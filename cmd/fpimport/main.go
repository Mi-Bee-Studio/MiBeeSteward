...
// databases into the MiBee rule format (see docs/en/fingerprint-spec.md).
//
// Supported sources:
//
...
//
// License posture (see docs/en/fingerprint-spec.md §8):
...
func writeFile(path string, v any) error {
	...
	header := fmt.Sprintf("# Generated by fpimport from %s.\n# See docs/en/fingerprint-spec.md §8 for license/attribution.\n", path)
